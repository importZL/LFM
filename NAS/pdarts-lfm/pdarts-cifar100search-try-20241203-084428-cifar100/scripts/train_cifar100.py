...
parser.add_argument('--save', type=str, default='pcdarts', help='experiment name')
parser.add_argument('--seed', type=int, default=0, help='random seed')
parser.add_argument('--arch', type=str, default='PCDARTS_LFM_cifar100_0503', help='which architecture to use')
parser.add_argument('--grad_clip', type=float, default=5, help='gradient clipping')
parser.add_argument('--resume', type=str, default='')
parser.add_argument('--is_parallel', type=int, default=0)
args = parser.parse_args()

args.save = './log/eval-cifar100-{}-{}'.format(args.save, time.strftime("%Y%m%d-%H%M%S"))
...
def main():
    ...
    if args.resume:
        ...
        valid_acc_best = checkpoint['best_acc']
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        logging.info('valid_acc %f, best_acc %f', valid_acc, valid_acc_best)

        utils.save(model, os.path.join(args.save, 'weights.pt'))

        save_checkpoint({
            'epoch': epoch + 1,
            'bset_acc': valid_acc_best,
