...
class WideResNet(MetaModule):
    def __init__(self, depth, num_classes, len_train, batch_size, widen_factor=1, dropRate=0.0):
        ...
        self.conv1 = MetaConv2d(3, nChannels[0], kernel_size=3, stride=1,
                               padding=1, bias=False)
        # 1st block
        self.block1 = MetaNetworkBlock(n, nChannels[0], nChannels[1], block, 2, dropRate)
        # 2nd block
