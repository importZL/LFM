...
class ResNet32(MetaModule):
    def __init__(self, num_classes, len_train, block=BasicBlock, num_blocks=[5, 5, 5]):
        ...
        self._initialize_weight_b(len_train)
    ...
    def _initialize_weight_b(self, len_train):
        self.weight_b = Variable(1.0 * torch.ones(100, len_train).cuda(), requires_grad=True)
        self._b_parameters = [
            self.weight_b,
        ]
